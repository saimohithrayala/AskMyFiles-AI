...
function App() {
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      const response = await fetch('https://rayalasaimohith---askmyfiles-backend.hf.space/upload', {
        method: 'POST',
        body: formData,
      });
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      const response = await fetch('https://rayalasaimohith---askmyfiles-backend.hf.space/chat', {
        method: 'POST',
